...
// Finance-only enhancers. Kept isolated so shared modules stay unchanged.
if (typeof window !== 'undefined' && /\/finance(?:\/|$)/.test(window.location.pathname)) {
  ...
  var financeUiScript = document.createElement('script');
  financeUiScript.src = '/shared/finance-light-ui.js';
  financeUiScript.async = true;
  document.head.appendChild(financeUiScript);
}
