...
function _tplInvoice(d, assets, company) {
  return [
    ...
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Nomor Invoice</td>',
    '<td>: <strong>' + _esc(d.DOCUMENT_NUMBER) + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Tanggal Invoice</td>',
    '<td>: ' + _esc(d.DOCUMENT_DATE) + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Jatuh Tempo</td>',
    '<td>: ' + _esc(d.DUE_DATE || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 6px 0;white-space:nowrap;">Status Pembayaran</td>',
    ...
    '</tr><tr>',
    '<td style="padding:2px 10px 2px 0;">PPN ' + _esc(d.TAX_PERCENT || '0') + '%</td>',
    '<td>: ' + _esc(d.TAX_AMOUNT || 'Rp 0') + '</td>',
    '</tr><tr>',
    '<td style="padding:4px 10px 4px 0;font-weight:bold;">GRAND TOTAL</td>',
    '<td style="font-weight:bold;color:#C40000;font-size:12pt;">: ' + _esc(d.GRAND_TOTAL || '') + '</td>',
    '</tr></table>',
    '<hr class="thin">',
    '<p class="section-title">INFORMASI PEMBAYARAN</p>',
    '<table style="width:auto;"><tr>',
    '<td style="padding:0 8px 3px 0;white-space:nowrap;">Bank</td>',
    '<td>: ' + _esc(d.BANK_NAME || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 3px 0;white-space:nowrap;">No. Rekening</td>',
    '<td>: <strong>' + _esc(d.BANK_ACCOUNT || '') + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:0 8px 3px 0;white-space:nowrap;">Atas Nama</td>',
    '<td>: ' + _esc(d.BANK_HOLDER || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 3px 0;white-space:nowrap;">Syarat Bayar</td>',
...
function _tplKwitansi(d, assets, company) {
  return [
    ...
    '<td style="width:48%;padding:0 8px 5px 0;white-space:nowrap;font-weight:bold;">Telah diterima dari</td>',
    '<td>: <strong>' + _esc(d.PAYER_NAME || '') + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:0 8px 5px 0;white-space:nowrap;">Tanggal Pembayaran</td>',
    '<td>: ' + _esc(d.PAYMENT_DATE || d.DOCUMENT_DATE) + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 5px 0;white-space:nowrap;">Keterangan</td>',
    '<td>: ' + _esc(d.PAYMENT_PURPOSE || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 5px 0;white-space:nowrap;">Rincian</td>',
    '<td>: ' + _esc(d.PAYMENT_DETAIL || '') + '</td>',
    '</tr></table>',
    '<hr class="thin" style="margin:10px 0;">',
    '<table style="width:auto;margin-left:auto;"><tr>',
    '<td style="padding:4px 10px 4px 0;font-weight:bold;font-size:12pt;">JUMLAH</td>',
...
function _tplSP(d, assets, company) {
  return [
    ...
    '<table style="width:100%;background:#FFF8F8;border:1.5px solid #F0C0C0;border-radius:4px;padding:10px;margin:10px 0;"><tr>',
    '<td style="width:40%;padding:4px 8px;white-space:nowrap;font-weight:bold;">Nama Karyawan</td>',
    '<td style="padding:4px 0;">: <strong>' + _esc(d.EMPLOYEE_NAME || '') + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:4px 8px;white-space:nowrap;">ID Karyawan</td>',
    '<td style="padding:4px 0;">: ' + _esc(d.EMPLOYEE_ID || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:4px 8px;white-space:nowrap;">Jabatan</td>',
    '<td style="padding:4px 0;">: ' + _esc(d.EMPLOYEE_POSITION || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:4px 8px;white-space:nowrap;">Departemen</td>',
    '<td style="padding:4px 0;">: ' + _esc(d.EMPLOYEE_DEPT || '') + '</td>',
    '</tr></table>',
    '<hr class="thin">',
    '<p>' + _esc(d.BODY || '') + '</p>',
    '<hr class="thin">',
...
function _tplKontrak(d, assets, company) {
  return [
    ...
    '<table style="width:auto;"><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Perusahaan</td>',
    '<td>: <strong>' + _esc(company.name) + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Diwakili oleh</td>',
    '<td>: ' + _esc(company.director_name || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Jabatan</td>',
    '<td>: ' + _esc(company.director_title || '') + '</td>',
    '</tr></table>',
    '<p class="section-title">PIHAK KEDUA</p>',
    '<table style="width:auto;"><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Nama</td>',
    '<td>: <strong>' + _esc(d.EMPLOYEE_NAME || '') + '</strong></td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">NIK / KTP</td>',
    '<td>: ' + _esc(d.EMPLOYEE_ID_CARD || d.EMPLOYEE_ID || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Jabatan</td>',
    '<td>: ' + _esc(d.EMPLOYEE_POSITION || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Departemen</td>',
...
function _tplMOU(d, assets, company) {
  return [
    ...
    '<td>: ' + _esc(company.director_title || '') + '</td>',
    '</tr><tr>',
    '<td style="padding:0 8px 4px 0;white-space:nowrap;">Alamat</td>',
