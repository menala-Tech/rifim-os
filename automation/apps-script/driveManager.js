...
function getTemplateCopy(templateId, docNumber) {
  ...
  // Nomor canonical: 001/RIFIM/INV/VIII/2026 -> docCode = INV (index 2).
  var parts = String(docNumber || '').split('/');
  var docCode = parts.length > 2 ? String(parts[2] || '').toUpperCase() : 'LAIN';
...
/** Existing callers are redirected to canonical Smart Office PDF storage. */
